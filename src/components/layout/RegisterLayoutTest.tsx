...
const RegisterLayoutTest = () => {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await fetch('http://localhost:5000/register', { // Backend chạy trên cổng 5000
        method: 'POST',
        headers: {
      ...
      console.log(data); // Xử lý dữ liệu phản hồi ở đây, chẳng hạn hiển thị thông báo đăng ký thành công
    } catch (error) {
