...
export default function HolidayLayout() {
    ...
    const oscarList = useAppSelector((state) => state.award.koreanList)
                    ...
                    <div className="lg:max-w-full w-full ">
                        ...
                        <div className="">
                            <div className="flex items-center ">
                                ...
                                <h2 className="lg:text-2xl text-lg font-bold text-black ">IMDb {translations[language]?.holidayPicks}</h2>
                            </div>
