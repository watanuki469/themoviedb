...
export default function StarmeterLayout() {
    const dispatch = useAppDispatch();
    const oscarList = useAppSelector((state) => state.award.emnysComedyList)
                    ...
                    <div className="lg:max-w-full w-full ">
                        ...
                        <div className="">
                            <div className="flex items-center ">
                                ...
                                <h2 className="lg:text-2xl text-lg font-bold text-black ">IMDb Starmeter</h2>
                            </div>
