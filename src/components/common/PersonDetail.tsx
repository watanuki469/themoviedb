...
export default function PersonDetail({
    ...
    const handleWatchList = async (
        ...
        await dispatch(fetchFavorite(
            movieId, movieName, movieImg, movieReleaseDay, movieReview, moviePopularity, movieKnowFor,
        ));
            ...
            <div className="text-white font-sans font-medium cursor-pointer" >
                ...
                <div style={{ position: "relative", zIndex: "1" }}>
                    ...
                    <div className="grid grid-cols-12 gap-y-4 h-full py-2">
                        <div className="hidden lg:block col-span-3 bg-gray-200  h-full rounded-xl">
                            <img
                        ...
                        <div className="lg:col-span-7 col-span-12 lg:ml-2 bg-black relative rounded-xl"
                            onClick={() => navigate(`/video/${singleMovieList[0]?.combined_credits?.cast[0]?.id}`)}>
                            <div className='min-h-60 rounded-xl'
                                style={{
                        ...
                        <div className="hidden lg:block col-span-2 h-full ml-2 overflow-hidden rounded-xl">
                            <div onClick={() => navigate(`/video/${singleMovieList[0]?.combined_credits?.cast[0]?.id}`)}
                                className="bg-gray-500 flex flex-col justify-center items-center h-1/2 mb-1 hover:opacity-90 rounded-xl">
                            ...
                            <div onClick={() => navigate(`/image/person/${singleMovieList[0]?.id}`)}
                                className="bg-gray-500 flex flex-col justify-center items-center h-1/2 mt-1 hover:opacity-90 rounded-xl">
                                <div className="flex flex-col justify-center items-center">
                                    <div className="text-center">
                                        <PhotoLibraryIcon />
                                    </div>
