...
export interface Translations {
  ...
  genre: string, chart: string, top250Movie: string, voter: string, sortBy: string,
  ...
  contributeZone: string,polls:string,holidayPicks:string
...
export const translations: Record<LanguageCode, Translations> = {
  ...
  'vi-VI': {
    ...
    seeOurPick: 'Xem lựa chọn của chúng tôi',
